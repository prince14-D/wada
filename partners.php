...
<title>Our Partners - West Africa Diving Association</title>
<!-- Google Fonts -->
...
<section class="text-white text-center py-5" 
         style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('images/Hull_Inspection.png') no-repeat center center/cover; height: 60vh; margin-top: 30px;">
  <div class="container" data-aos="fade-up">
    <h1 class="display-4 fw-bold">Our Partners</h1>
    <p class="lead">We collaborate with top maritime authorities and trusted organizations to ensure excellence</p>
  </div>
</section>
...
<section class="container my-5 py-5" data-aos="fade-up">
  <h2 class="text-primary mb-5 text-center display-5 fw-bold">Our Trusted Partners</h2>
